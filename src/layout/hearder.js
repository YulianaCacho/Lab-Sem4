...
const Hearder= () => {
    return <hearder>
    <nav className="navbar navbar-expand-lg" style={{backgroundColor: '#5BBCFF'}}>
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Playas</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#"><i data-feather="globe"></i>Latinoamerica</a>
            </li>
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Lugares</a>
